...
public class LoginPanel extends JPanel {
	...
	cbxEmailHost = new JComboBox<String>(new String[] { "126.com", "163.com", "qq.com", "yeah.net"});
	...
	btnLogin.addActionListener(new ActionListener() {
		...
		if("".equals(txtEmailAddress.getText()) || "".equals(txtEmailPassword.getText())) {
		    return;
		}
		String host = cbxEmailHost.getItemAt(cbxEmailHost.getSelectedIndex());
		boolean result = EmailAccountCheck.checkEmailAccount(host, "smtp", txtEmailAddress.getText() + "@" + host, txtEmailPassword.getText());
		if(result) {
		    int select = JOptionPane.showConfirmDialog(null, "成功创建账号，马上进入？", "", JOptionPane.OK_CANCEL_OPTION);
