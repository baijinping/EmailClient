...
public class LinkManUI extends JFrame {

    private LinkManPanel panel;

    public LinkManUI() {
	super();
	setTitle("暖冬 Email Client -> 联系人管理");
	
	panel = new LinkManPanel();
	add(panel);
    ...
    public void show() {
	super.show();
	panel.updateLinkManList();
	panel.showLinkManInfo(0, false);
    }
